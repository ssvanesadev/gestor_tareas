...
class FrontController {
      static function main() {
            ...
            // CORRECCIÓN: Obtener la instancia de Config
            ...
            if (!empty($_REQUEST['controlador']))
                  $controllerName = $_REQUEST['controlador'];
            else
                  $controllerName = "TareaController"; // CAMBIADO: TareaController como defecto
            ...
            if (is_file($controllerPath))
                  ...
                  die('El controlador no existe - 404 not found - Ruta: ' . $controllerPath);
